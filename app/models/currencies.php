...
class Currencies extends AppModel {
	...
	public function add(array $vars) {
		...
		if ($this->Input->validates($vars)) {
			// Add a currency
			$fields = array("code", "company_id", "format", "precision",
	...
	public function edit($currency_code, $company_id, array $vars) {
		...
		if ($this->Input->validates($vars)) {
			// Update a currency
			$fields = array("format", "precision", "prefix", "suffix", "exchange_rate", "exchange_updated");
	...
	private function getRules($vars) {
		$rules = array(
			...
			'precision' => array(
				'format' => array(
					'if_set' => true,
					'rule' => array("in_array", array("0", "1", "2", "3", "4")),
