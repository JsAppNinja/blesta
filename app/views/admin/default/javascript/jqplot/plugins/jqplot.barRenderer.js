			...
			for (var i=0; i<gridData.length; i++) {
				...
				if (this.showGradient) {
					if (this.gradientColor == undefined) {
						this.gradientColor = Array("rgba(0,0,0,0.35)", "rgba(0,0,0,0.15)", "rgba(0,0,0,0)");
					}
					
					this.gradientDir = (this.gradientDir == undefined ? "" : this.gradientDir);
					switch (this.gradientDir) {
						default:
						case "N":
							if (this.barDirection == "vertical") {
								x1 = base-this.barWidth/2;
								y1 = ystart;
								x2 = base-this.barWidth/2;
								y2 = gridData[i][1];
							}
							else {
								y1 = base-this.barWidth/2;
								x1 = xstart;
								y2 = base-this.barWidth/2;
								x2 = gridData[i][0];								
							}
							break;
						case "S":
					...
					gradient.addColorStop(0.3, this.gradientColor[1]);
					gradient.addColorStop(1, this.gradientColor[2]);
					ctx.fillStyle = gradient;
					if (this.barDirection == 'vertical')
						ctx.fillRect(base-this.barWidth/2, gridData[i][1], this.barWidth, ystart-gridData[i][1]);
					else
						//ctx.fillRect(base-this.barWidth/2, gridData[i][1], this.barWidth, ystart-gridData[i][1]);
						ctx.fillRect(xstart, base-this.barWidth/2, gridData[i][0], base+this.barWidth/2);
				}
            }
        }                
