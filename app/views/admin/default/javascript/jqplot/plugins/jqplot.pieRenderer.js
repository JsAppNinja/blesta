...
(function($) {
    ...
    $.jqplot.PieRenderer.prototype.draw = function (ctx, gd, options, plot) {
		...
		if (this.showGradient) {
			...
			var inner_x = this._center[0]-inner_r;
			var inner_y = this._center[1]-inner_r;
			// inner circle (x, y, r), outter circle (x, y, r)
			var gradient = ctx.createRadialGradient(inner_x,inner_y,inner_r,this._center[0],this._center[1],r);
