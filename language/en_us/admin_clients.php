...
$lang['AdminClients.!success.service_in_review'] = "Services with the status %1\$s cannot be updated."; // %1$s is the language for the In Review status
...
$lang['AdminClients.editservice.field_coupon_code'] = "Coupon Code";
$lang['AdminClients.editservice.tooltip_coupon_code'] = "Coupon must be valid, and will be applied when service renews. Inclusive coupons must be added to all relevant services.";
