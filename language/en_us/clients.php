...
// Client errors
$lang['Clients.!error.id_format.empty'] = "No ID format set for invoices.";
$lang['Clients.!error.id_format.length'] = "The ID format for invoices may not exceed 64 characters.";
$lang['Clients.!error.id_value.valid'] = "Unable to determine invoice ID value.";
...
$lang['Clients.!error.client_id.deleteable'] = "The client you are trying to delete has invoice, service, or transaction data. Deleting the client will cause a data anomaly. You may wish to mark the client as inactive instead.";
