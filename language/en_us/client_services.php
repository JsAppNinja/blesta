...
$lang['ClientServices.!error.module_tab_unavailable'] = "That section is not accessible while the service is in a %1\$s state."; // %1$s is the language for the service status (e.g. Suspended, Canceled)
...
$lang['ClientServices.change_term.text_next_cycle'] = "Selecting a new term will cause the service to renew at the new term for the next billing cycle.";
