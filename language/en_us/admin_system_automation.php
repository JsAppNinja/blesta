...
$lang['AdminSystemAutomation.index.field_croncommand'] = "Cron Command";
...
$lang['AdminSystemAutomation.index.note_cron_command'] = "Be sure to update the cron command to point to where PHP is installed if it differs from what is shown.";
?>