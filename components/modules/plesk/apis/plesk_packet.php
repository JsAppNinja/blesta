...
<packet version="{$this->api_version}" />
XML;
	 ...
	 */
	public function insert(array $elements=array(), $path="/packet") {
	 ...
	 */
	private function buildElements(array $elements=array(), SimpleXMLElement $element=null) {
		if (empty($elements))
			return $element;
