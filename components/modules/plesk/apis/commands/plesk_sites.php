...
class PleskSites extends PleskPacket {
	...
	public function add(array $vars) {
		...
		if (isset($vars['htype'])) {
			$hosting = array_merge((isset($vars['hosting']) ? $vars['hosting'] : array()), array('htype' => $vars['htype']));
	...
	private function buildHosting(array $vars, $container) {
		...
		elseif (in_array($vars['htype'], array("std_fwd", "frm_fwd"))) {
			...
			if ($vars['htype'] == "std_fwd" && isset($vars['http_code']))
				$this->insert(array('http_code' => $vars['http_code']), $container . "/hosting/std_fwd");
		}
		else {
			// None
