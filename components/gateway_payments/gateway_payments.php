...
class GatewayPayments {
	...
	public function __construct() {
		...
		Loader::loadHelpers($this, array("DataStructure", "Date", "CurrencyFormat"=>array($this->company_id)));
	...
	public function processNotification($gateway_name, array $get, array $post) {
		...
		if (($errors = $this->Transactions->errors()))
			...
			if (isset($response['status']) && isset($response['client_id']) &&
				...
				$this->Emails->send("payment_nonmerchant_approved", $this->company_id, $client->settings['language'], $client->email, $tags, null, null, null, array('to_client_id'=>$client->id));
			}
