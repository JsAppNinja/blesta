...
class Interfax {
	 ...
	 */
	private $available_file_types = array("HTML", "DOC", "PDF");
	/**
	 * @var array An array of available page sizes accepted by Interfax
	 */
	private $available_page_sizes = array("A4", "Letter", "Legal", "B4");
	/**
	 * @var array An array of available page orientations
	 */
	private $available_page_orientations = array("Landscape", "Portrait");
	/**
	...
	public function __construct() {
		Loader::loadHelpers($this, array("Date", "DataStructure"));
	...
	public function setResolution($resolution) {
		if (in_array($resolution, array("0", "1")))
	 ...
	 *
	 * @param string $date_time A valid PHP date time stamp
	 */
...
EOT;
		...
		$this->Http->setHeaders(array("User-Agent: NuSOAP/0.7.3 (1.114)",
	...
	private function parseResponse($response) {
		...
		try {
			...
			if (is_object($xml)) {
				...
				$temp = (array)$xml->children("soap", true)->Body->children("", true)->SendfaxEx_2Response->SendfaxEx_2Result;
