...
Configure::set("none.map", array(
	...
	'module_row_meta' => array(
		...
		(object)array('key' => "service_field_label_0", 'value' => "User 1", 'serialized' => 0, 'encrypted' => 0),
		...
		(object)array('key' => "service_field_label_1", 'value' => "User 2", 'serialized' => 0, 'encrypted' => 0),
		...
		(object)array('key' => "service_field_label_3", 'value' => "Option 1", 'serialized' => 0, 'encrypted' => 0),
		...
		(object)array('key' => "service_field_label_4", 'value' => "Option 2", 'serialized' => 0, 'encrypted' => 0),
		(object)array('key' => "service_field_name_4", 'value' => "opt2", 'serialized' => 0, 'encrypted' => 0),
		(object)array('key' => "service_field_type_4", 'value' => "text", 'serialized' => 0, 'encrypted' => 0),
		(object)array('key' => "service_field_required_4", 'value' => "true", 'serialized' => 0, 'encrypted' => 0),
		(object)array('key' => "service_field_encrypt_4", 'value' => "false", 'serialized' => 0, 'encrypted' => 0),
		(object)array('key' => "service_field_values_4", 'value' => "", 'serialized' => 0, 'encrypted' => 0)
	),
	'package_meta' => array(),
	'service_fields' => array(
		...
		'opt2' => (object)array('key' => "opt2", 'serialized' => 0, 'encrypted' => 0),
	)
));
?>