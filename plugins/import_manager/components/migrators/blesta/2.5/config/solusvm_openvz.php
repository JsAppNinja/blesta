<?php
Configure::set("solusvm_openvz.map", array(
	'module' => "solusvm",
	...
	'package_meta' => array(
		...
		(object)array('key' => "nodes", 'value' => (object)array('package' => "instantact"), 'serialized' => 1, 'encrypted' => 0, 'callback' => "solusvm_openvz_nodes"),
		(object)array('key' => "plan", 'value' => (object)array('package' => "instantact"), 'serialized' => 0, 'encrypted' => 0, 'callback' => "solusvm_openvz_plan"),
