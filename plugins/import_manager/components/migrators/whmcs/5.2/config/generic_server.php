<?php
Configure::set("generic_server.map", array(
	...
	'module_row_meta' => array(
		...
		(object)array('key' => "service_field_name_0", 'value' => "username", 'serialized' => 0, 'encrypted' => 0),
		...
		(object)array('key' => "service_field_label_1", 'value' => "Domain", 'serialized' => 0, 'encrypted' => 0),
		(object)array('key' => "service_field_name_1", 'value' => "domain", 'serialized' => 0, 'encrypted' => 0),
		...
		(object)array('key' => "service_field_name_2", 'value' => "password", 'serialized' => 0, 'encrypted' => 0),
	...
	'service_fields' => array(
		...
		'username' => (object)array('key' => "username", 'serialized' => 0, 'encrypted' => 0),
		'password' => (object)array('key' => "password", 'serialized' => 0, 'encrypted' => 1)
	)
));
?>