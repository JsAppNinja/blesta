...
class WhmcsInvoices {
	...
	public function get() {
		return $this->remote->select(array("tblinvoices.*", 'tblcurrencies.code' => "currency"))->from("tblinvoices")->
	...
	public function getRecurringLines() {
		return $this->remote->select(array("tblbillableitems.*", 'tblcurrencies.code' => "currency"))->
