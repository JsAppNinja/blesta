...
class AdminMain extends ClientDocumentsController {
	...
	public function preAction() {
		...
		$this->uses(array("Clients", "ClientDocuments.ClientDocumentsFiles"));
	...
	public function index() {
		...
		$this->set("documents", $this->ClientDocumentsFiles->getAll($client->id, array($sort => $order)));
		$this->set("sort", $sort);
	...
	public function delete() {
		...
		if (!isset($this->post['id']) || !($document = $this->ClientDocumentsFiles->get($this->post['id'])) || !($client = $this->Clients->get($document->client_id)))
			$this->redirect($this->base_uri . "clients/");
